...
export function ScanMeSection() {
  ...
  return (
    <section id="scan" className="py-20 px-4 bg-blue-50 relative overflow-hidden">
      {/* Animated background elements */}
      <div className="absolute inset-0">
        <div className="absolute top-20 left-10 w-32 h-32 bg-blue-200/30 rounded-full animate-pulse"></div>
        <div className="absolute top-60 right-20 w-40 h-40 bg-blue-300/30 rounded-full animate-bounce"></div>
        <div className="absolute bottom-40 left-1/4 w-28 h-28 bg-blue-400/30 rounded-full animate-pulse"></div>
        <div className="absolute bottom-20 right-10 w-36 h-36 bg-blue-500/30 rounded-full animate-bounce"></div>
      </div>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-blue-100 px-4 py-2 rounded-full mb-6">
            ...
            <span className="font-medium text-blue-700">Ready to Download</span>
          </div>
          
          <h2 className="text-4xl lg:text-6xl font-bold mb-6 text-blue-900">
            Scan & Download Now!
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {/* iOS App Store */}
          <Card className="bg-white/80 backdrop-blur-lg border-2 border-blue-100 hover:border-blue-300 hover:shadow-2xl transition-all duration-500 transform hover:scale-105 group">
            <CardContent className="p-8 text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                {/* iOS Icon */}
                <div className="w-20 h-20 bg-blue-500 rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="space-y-4">
                  ...
                  <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white py-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
          ...
          <Card className="bg-white/80 backdrop-blur-lg border-2 border-green-100 hover:border-green-300 hover:shadow-2xl transition-all duration-500 transform hover:scale-105 group">
            <CardContent className="p-8 text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                {/* Android Icon */}
                <div className="w-20 h-20 bg-blue-600 rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:shadow-xl transition-shadow duration-300">
                  <span className="text-3xl">🤖</span>
                </div>

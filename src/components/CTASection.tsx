  ...
  return (
    <section className="py-20 px-4 bg-red-900 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-10 left-10 w-20 h-20 bg-red-400/10 rounded-full animate-pulse"></div>
      ...
      <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
          <Button size="lg" className="bg-red-600 hover:bg-red-700 text-white px-8 py-4 rounded-xl flex items-center gap-3 shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
            <span className="text-2xl">📱</span>
            Download on App Store
          </Button>
          <Button size="lg" className="bg-red-700 hover:bg-red-800 text-white px-8 py-4 rounded-xl flex items-center gap-3 shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
            <span className="text-2xl">🤖</span>
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 mt-8 border border-white/10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div className="space-y-2">
              <div className="text-2xl font-bold text-red-300">4.8★</div>
